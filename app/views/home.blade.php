...
@if (Sentry::check())
<!-- If user logged in then logout section -->
<a href="{{ URL::to('logout') }}"><div id="hero_login_btn">Hello, <?php echo Sentry::getUser()->first_name; ?> Log Out</div></a>
@else
<!-- If user not logged in then login button -->
<a href="{{ URL::to('index.php/login') }}"><div id="hero_login_btn">Log In</div></a>
@endif
<div id="hero_logo"></div>
<div id="hero_logo_text">TalentPool</div>
<div id="hero_logo_subtitle">Graduates & Young Professionals</div>
@if (Sentry::check())
<a href="{{ URL::to('profile') }}"><div id="hero_sign_up_btn">Visit Profile</div></a>
@else
